...
# Actor shadow size. If not specified here, the default value of 60 is used. A value of 0 will cause the shadow to be omitted.
# TODO: calculate shadow size from geo verts
shadowSizes = {"pipeMimic":125, "bonfire":0, "unstablePlatform":0, "shortcutElevator":0,"floorArrowTrap":0, "fogDoor":0, "smoughMass":75}
# view frustrum culling radius. If not specified here, the node is left out, resulting in a default value of 300
cullingRadii = {"unstablePlatform":"3000","pipeMimic":"1000","fogDoor":"1500"}
# scrolling textures to label for easy access
scrollingTextures = {"model_texture_0":"clouds_texLoad", "model_texture_8":"purpleGoop_texLoad", "fogDoor_texture_0":"fogDoor_texLoad", "smoughMass_texture_0":"smoughMass_texLoad"}
